...
public class totitoController implements Initializable {
    ...
    @FXML
    Button btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnMenu;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            imagenCirculo = new Image(getClass().getResourceAsStream("/org/kinalarcade/image/circle.png"));
            imagenCruz = new Image(getClass().getResourceAsStream("/org/kinalarcade/image/X.png"));
        } catch (Exception e) {
    ...
    @FXML
    public void clicRegresarT(ActionEvent evento){
